...
--
-- Name: ds_comments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ds_comments (
    id bigint NOT NULL,
...
--
-- Name: ds_comments_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.ds_comments_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ds_comments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.ds_comments_id_seq OWNED BY public.ds_comments.id;
...
--
-- Name: ds_comments id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ds_comments ALTER COLUMN id SET DEFAULT nextval('public.ds_comments_id_seq'::regclass);
...
--
-- Name: ds_comments ds_comments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ds_comments
    ADD CONSTRAINT ds_comments_pkey PRIMARY KEY (id);
...
--
-- Name: index_ds_comments_on_device_story_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_ds_comments_on_device_story_id ON public.ds_comments USING btree (device_story_id);
